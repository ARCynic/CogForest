...
export default function MusicAsRegulationIndex() {
  const sections = useMemo(() => {
    const seriesItems = musicAsRegulation.filter((e) => !!e.seriesKey || !!e.isSeries);
    const singles = musicAsRegulation.filter((e) => !e.seriesKey && !e.isSeries);
  ...
  return (
    <div className="mx-auto max-w-5xl px-2 sm:px-0">
      <Header
        ...
        desc="Pieces on using sound and rhythm to steady attention and mood."
        stamp={stamp}
      />
