...
import stamp from "../../../assets/stamp_satire.png";
...
export default function SatireIndex() {
  const sections = useMemo(() => {
    const seriesItems = satire.filter((e) => !!e.seriesKey || !!e.isSeries);
    const singles = satire.filter((e) => !e.seriesKey && !e.isSeries);
  ...
  return (
    <div className="mx-auto max-w-5xl px-2 sm:px-0">
      <Header
        ...
        desc="Short scenes that expose incentives, status, and institutional nonsense."
        stamp={stamp}
      />
