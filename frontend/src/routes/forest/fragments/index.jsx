...
import stamp from "../../../assets/stamp_fragments.png";
...
export default function FragmentsIndex() {
  const sections = useMemo(() => {
    const seriesItems = fragments.filter((e) => !!e.seriesKey || !!e.isSeries);
    const singles = fragments.filter((e) => !e.seriesKey && !e.isSeries);
  ...
  return (
    <div className="mx-auto max-w-5xl px-2 sm:px-0">
      <Header
        ...
        desc="Short reflections on choice, control, responsibility, and meaning."
        stamp={stamp}
      />
