...
export default function LanguageIndex() {
  const sections = useMemo(() => {
    const seriesItems = language.filter((e) => !!e.seriesKey || !!e.isSeries);
    const singles = language.filter((e) => !e.seriesKey && !e.isSeries);
  ...
  return (
    <div className="mx-auto max-w-5xl px-2 sm:px-0">
      <Header
        ...
        desc="Notes on self-learning languages, cultural patterning, and how meaning shifts across contexts."
        stamp={stamp}
      />
